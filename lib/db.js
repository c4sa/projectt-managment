...
const COLS = {
  projects: ['id','name','code','status','customer_id','project_manager','assistant_pm','assigned_manager_id','assigned_manager_name','team_members','start_date','end_date','description','location','budget','spent','contract_value','vat_status','contract_document','contract_link','created_at'],
